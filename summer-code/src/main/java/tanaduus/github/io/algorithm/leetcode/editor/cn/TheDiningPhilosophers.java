...
public class TheDiningPhilosophers {
    ...
    class DiningPhilosophers {
        ...
        public DiningPhilosophers() {
            forks = new HashMap<>();
            forks.put(0, new Object());
            forks.put(1, new Object());
            forks.put(3, new Object());
            forks.put(4, new Object());
            forks.put(5, new Object());
        }

        Map<Integer, Object> forks;
        ...
        public void wantsToEat(int philosopher,
            ...
            Object leftFork = forks.get(philosopher);
            Object rightFork;
            if (philosopher == 4) {
                rightFork = forks.get(0);
            } else {
                rightFork = forks.get(philosopher + 1);
            }
